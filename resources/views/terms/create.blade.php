...
@section('content')
<h3 class="w-50 bg-dark text-primary text-center mb-3 mt-2 py-2 mx-auto" style="bottom: 10px; border-radius: 20px;">Terms</h3>
<form class="bg-dark mx-4 mt-4" method="POST" action="{{ route('techquestions.store') }}" style="border-radius: 20px;">
    ...
    <div class="form-group px-4"> 
        <h5 class="text-light font-weight-bold">Definition</h5>
