...
@section('content')
    ...
    <div class="card bg-dark mx-4 mt-3 mb-5 text-light" style="border-radius: 20px;">
        ...
        <div class="card-body">
            ...
            <p class="card-text d-inline pl-3" style="font-size: 22px; white-space: pre;">{{ $term->category }}</p>
            ...
            <div class="d-flex">
                ...
                <div class="d-inline pl-3">
                    <p class="bg-dark text-light border-light" style="font-size: 22px; white-space: normal;">{{ $term->definition_eng }}</p>
                </div>    
            </div>  
            <div class="d-flex">
                <div class="d-inline">
                ...
                <div class="d-inline pl-3">
                    <p class="bg-dark text-light border-light" style="font-size: 22px; white-space: normal;">{{ $term->definition_hun }}</p>
                </div> 
            </div>   
        </div>
    </div>
