...
@section('content')
    ...
    <div class="card bg-dark mx-4 text-light border border-secondary" style="border-radius: 20px;">
        ...
        <div class="card-body">
            <p class="card-text text-primary d-inline" style="font-family: 'Michroma', sans-serif; font-size: 20px;">Category:</p>
            <p class="card-text d-inline pl-3" style="font-size: 22px; white-space: pre-wrap;">{{ $term->category }}</p>
            <hr class="border-light">
            <p class="card-text text-primary d-inline" style="font-family: 'Michroma', sans-serif; font-size: 20px;">Term:</p>
            <p class="card-text d-inline pl-3" style="font-size: 22px; white-space: pre-wrap;">{{ $term->term }}</p>
            <hr class="border-light">
            <div class="d-flex">
                <div class="d-inline">
                    <p class="card-text text-primary d-inline" style="font-family: 'Michroma', sans-serif; font-size: 20px;">Definition:</p>
                </div>
